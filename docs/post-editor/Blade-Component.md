...
same page. See [Livewire](Livewire-Integration.md) and [Inertia](Inertia-Integration.md) for
embedding recipes.
...
- [Quick Start](../Quick-Start.md) — end-to-end install
- [Livewire](Livewire-Integration.md) / [Inertia](Inertia-Integration.md) — embedding recipes

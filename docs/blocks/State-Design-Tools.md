...
- [Theming](../post-editor/Theming.md) — for the broader theme.json hierarchy (where overrides live).
- [Responsive Design Tools](Responsive-Design-Tools.md) — sister feature with the same value-resolver shape.
- [Configuration](../Configuration.md#states) — for the host-app config override path.

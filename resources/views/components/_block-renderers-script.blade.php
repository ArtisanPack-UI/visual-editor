{{--
 * Block Renderers Script
 *
 * Shared Alpine.js script block that registers the blockRenderers store,
 * veInlineLinkControl Alpine data, and all core block JS renderers.
 * Included by all editor variants (Editor, TemplateEditor,
 * TemplatePartEditor, PatternEditor).
 *
 * Required variables: $blockMetadata
 *

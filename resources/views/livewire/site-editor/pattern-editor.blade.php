 ...
 * Pattern Editor Page
 *
 * Full-page Livewire view that mounts the pattern block editor.
	...
	x-data="{
		save() {
			...
			setTimeout( () => {
				...
				const settings = JSON.parse( JSON.stringify( store.patternSettings || {} ) );
...
>
	{{-- Pattern Editor — wire:ignore prevents Livewire morphdom

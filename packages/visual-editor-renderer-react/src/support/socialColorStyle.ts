/**
 * Builds the CSS-style object applied to a social chip (share / author
 * flavours) so saved icon-color attributes flow through identically to
 * the editor preview and the Blade / Vue renderers.
 *

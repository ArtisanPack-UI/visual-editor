/**
 * React renderer for the `artisanpack/social-share-content` block (#501).
 *
...
export function SocialShareContentBlock({
    attributes,
    ...
    const chips = resolvedChips(selected, attributes._resolvedShareLinks);
    ...
    return (
        <div className={classes}>
            {chips.map((chip) => (
                <div className="ap-social-share-content__item" key={chip.slug}>
                    <a

 ...
 * to a platform share URL. The path map lives here so the Blade
 * partials stay terse and so renderer-parity tests can compare the
 * same source-of-truth to the React + Vue counterparts.
 *
...
class SocialIconRegistry
{
	 ...
	 */
	protected const AUTHOR_PLATFORMS = [
		'facebook'  => [
			'label' => 'Facebook',
	...
	/**
	 * Share-target platforms — slug => { label, path }.
	 *
	 * @var array<string, array{label: string, path: string}>
	 */
	protected const SHARE_PLATFORMS = [
		'facebook'  => [
			'label' => 'Facebook',
			'path'  => 'M13 7h3V4h-3a4 4 0 0 0-4 4v2H6v3h3v7h3v-7h3l1-3h-4V8a1 1 0 0 1 1-1Z',
		],
	...
	{
		return self::AUTHOR_PLATFORMS[ $slug ] ?? null;
	}
	...
	{
		return self::SHARE_PLATFORMS[ $slug ] ?? null;
	}
}

	...
	public function getContentSchema(): array
	{
		return [
			...
			'markerLabel' => [
				...
				'options'  => [
					''           => __( 'visual-editor::ve.map_marker_none' ),
					'Location'   => __( 'visual-editor::ve.map_marker_location' ),
					'Business'   => __( 'visual-editor::ve.map_marker_business' ),
					'Home'       => __( 'visual-editor::ve.map_marker_home' ),
					'Office'     => __( 'visual-editor::ve.map_marker_office' ),
					'Restaurant' => __( 'visual-editor::ve.map_marker_restaurant' ),
					'Store'      => __( 'visual-editor::ve.map_marker_store' ),
					'Event'      => __( 'visual-editor::ve.map_marker_event' ),
				],
				'default'  => '',
				'showWhen' => [ 'provider' => 'google' ],
			],

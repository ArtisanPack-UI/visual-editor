...
>
	...
	<div class="flex items-center" role="group" aria-label="{{ __( 'visual-editor::ve.vertical_alignment' ) }}">
		<button type="button" class="flex items-center justify-center rounded px-2.5 py-1.5 text-base-content/70 hover:bg-base-200 hover:text-base-content transition-colors" :class="vAlign === 'start' ? 'bg-base-200' : ''" x-on:click="updateAttr( { verticalAlignment: 'start' } )" :aria-pressed="( vAlign === 'start' ).toString()" title="{{ __( 'visual-editor::ve.top' ) }}" aria-label="{{ __( 'visual-editor::ve.top' ) }}">
		...
		<button type="button" class="flex items-center justify-center rounded px-2.5 py-1.5 text-base-content/70 hover:bg-base-200 hover:text-base-content transition-colors" :class="vAlign === 'end' ? 'bg-base-200' : ''" x-on:click="updateAttr( { verticalAlignment: 'end' } )" :aria-pressed="( vAlign === 'end' ).toString()" title="{{ __( 'visual-editor::ve.bottom' ) }}" aria-label="{{ __( 'visual-editor::ve.bottom' ) }}">

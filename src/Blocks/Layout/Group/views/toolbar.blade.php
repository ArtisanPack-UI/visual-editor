...
>
	...
	<div class="flex items-center" role="group" aria-label="{{ __( 'visual-editor::ve.justify_content' ) }}">
		<button type="button" class="flex items-center justify-center rounded px-2.5 py-1.5 text-base-content/70 hover:bg-base-200 hover:text-base-content transition-colors" :class="justifyContent === 'flex-start' ? 'bg-base-200' : ''" x-on:click="setJustify( 'flex-start' )" :aria-pressed="( justifyContent === 'flex-start' ).toString()" aria-label="{{ __( 'visual-editor::ve.justify_start' ) }}">
		...
		<button type="button" class="flex items-center justify-center rounded px-2.5 py-1.5 text-base-content/70 hover:bg-base-200 hover:text-base-content transition-colors" :class="justifyContent === 'center' ? 'bg-base-200' : ''" x-on:click="setJustify( 'center' )" :aria-pressed="( justifyContent === 'center' ).toString()" aria-label="{{ __( 'visual-editor::ve.justify_center' ) }}">
			<svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
		...
		<button type="button" class="flex items-center justify-center rounded px-2.5 py-1.5 text-base-content/70 hover:bg-base-200 hover:text-base-content transition-colors" :class="justifyContent === 'flex-end' ? 'bg-base-200' : ''" x-on:click="setJustify( 'flex-end' )" :aria-pressed="( justifyContent === 'flex-end' ).toString()" aria-label="{{ __( 'visual-editor::ve.justify_end' ) }}">
			<svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
		...
		<template x-if="'row' === flexDirection || ( 'column' === flexDirection && block?.attributes?.flexWrap === 'nowrap' && block?.innerBlocks?.length > 0 )">
			<button type="button" class="flex items-center justify-center rounded px-2.5 py-1.5 text-base-content/70 hover:bg-base-200 hover:text-base-content transition-colors" :class="justifyContent === 'space-between' ? 'bg-base-200' : ''" x-on:click="setJustify( 'space-between' )" :aria-pressed="( justifyContent === 'space-between' ).toString()" aria-label="{{ __( 'visual-editor::ve.justify_space_between' ) }}">
				<svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
					<line x1="4" y1="4" x2="4" y2="20" />
					<line x1="20" y1="4" x2="20" y2="20" />
	...
	<template x-if="block?.innerBlocks?.length > 0">
		<div class="flex items-center" role="group" aria-label="{{ __( 'visual-editor::ve.orientation' ) }}">
			<div class="w-px h-5 bg-base-300 mx-0.5" aria-hidden="true"></div>
			<button type="button" class="flex items-center justify-center rounded px-2.5 py-1.5 text-base-content/70 hover:bg-base-200 hover:text-base-content transition-colors" :class="'row' === flexDirection ? 'bg-base-200' : ''" x-on:click="setDirection( 'row' )" title="{{ __( 'visual-editor::ve.orientation_horizontal' ) }}" aria-label="{{ __( 'visual-editor::ve.orientation_horizontal' ) }}" :aria-pressed="( 'row' === flexDirection ).toString()">
				<svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
					<path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
				</svg>
			</button>
			<button type="button" class="flex items-center justify-center rounded px-2.5 py-1.5 text-base-content/70 hover:bg-base-200 hover:text-base-content transition-colors" :class="'column' === flexDirection ? 'bg-base-200' : ''" x-on:click="setDirection( 'column' )" title="{{ __( 'visual-editor::ve.orientation_vertical' ) }}" aria-label="{{ __( 'visual-editor::ve.orientation_vertical' ) }}" :aria-pressed="( 'column' === flexDirection ).toString()">
				<svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">

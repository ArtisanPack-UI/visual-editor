...
>
	...
	<div class="flex items-center" role="group" aria-label="{{ __( 'visual-editor::ve.vertical_alignment' ) }}">
		<button type="button" class="btn btn-ghost btn-xs btn-square" :class="vAlign === 'top' ? 'bg-base-200' : ''" x-on:click="updateAttr( { verticalAlignment: 'top' } )" :aria-pressed="( vAlign === 'top' ).toString()" title="{{ __( 'visual-editor::ve.top' ) }}" aria-label="{{ __( 'visual-editor::ve.top' ) }}">
		...
		<button type="button" class="btn btn-ghost btn-xs btn-square" :class="vAlign === 'bottom' ? 'bg-base-200' : ''" x-on:click="updateAttr( { verticalAlignment: 'bottom' } )" :aria-pressed="( vAlign === 'bottom' ).toString()" title="{{ __( 'visual-editor::ve.bottom' ) }}" aria-label="{{ __( 'visual-editor::ve.bottom' ) }}">

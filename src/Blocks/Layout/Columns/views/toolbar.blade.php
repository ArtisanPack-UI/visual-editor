...
>
	...
	<div class="flex items-center" role="group" aria-label="{{ __( 'visual-editor::ve.vertical_alignment' ) }}">
		<button type="button" class="flex items-center justify-center rounded px-2.5 py-1.5 text-base-content/70 hover:bg-base-200 hover:text-base-content transition-colors" :class="vAlign === 'top' ? 'bg-base-200' : ''" x-on:click="setVAlign( 'top' )" title="{{ __( 'visual-editor::ve.top' ) }}" aria-label="{{ __( 'visual-editor::ve.top' ) }}" :aria-pressed="( vAlign === 'top' ).toString()">
		...
		<button type="button" class="flex items-center justify-center rounded px-2.5 py-1.5 text-base-content/70 hover:bg-base-200 hover:text-base-content transition-colors" :class="vAlign === 'center' ? 'bg-base-200' : ''" x-on:click="setVAlign( 'center' )" title="{{ __( 'visual-editor::ve.center' ) }}" aria-label="{{ __( 'visual-editor::ve.center' ) }}" :aria-pressed="( vAlign === 'center' ).toString()">
		...
		<button type="button" class="flex items-center justify-center rounded px-2.5 py-1.5 text-base-content/70 hover:bg-base-200 hover:text-base-content transition-colors" :class="vAlign === 'bottom' ? 'bg-base-200' : ''" x-on:click="setVAlign( 'bottom' )" title="{{ __( 'visual-editor::ve.bottom' ) }}" aria-label="{{ __( 'visual-editor::ve.bottom' ) }}" :aria-pressed="( vAlign === 'bottom' ).toString()">
		...
		<button type="button" class="flex items-center justify-center rounded px-2.5 py-1.5 text-base-content/70 hover:bg-base-200 hover:text-base-content transition-colors" :class="vAlign === 'stretch' ? 'bg-base-200' : ''" x-on:click="setVAlign( 'stretch' )" title="{{ __( 'visual-editor::ve.stretch' ) }}" aria-label="{{ __( 'visual-editor::ve.stretch' ) }}" :aria-pressed="( vAlign === 'stretch' ).toString()">

...
>
	...
	<button
		...
		:aria-label="showCitation ? {{ Js::from( __( 'visual-editor::ve.remove_citation' ) ) }} : {{ Js::from( __( 'visual-editor::ve.add_citation' ) ) }}"
		:title="showCitation ? {{ Js::from( __( 'visual-editor::ve.remove_citation' ) ) }} : {{ Js::from( __( 'visual-editor::ve.add_citation' ) ) }}"
	>

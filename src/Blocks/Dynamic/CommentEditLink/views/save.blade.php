@php
	...
	$editUrl     = veGetContentCommentEditUrl( $context );
	$displayText = $text ?: __( 'visual-editor::ve.comment_edit_link_default' );
	...
	$classes = 've-block ve-block-comment-edit-link';
	if ( $safeFontSize ) {

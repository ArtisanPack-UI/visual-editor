@php
	...
	$queryType = $content['queryType'] ?? 'post';
	$perPage   = $content['perPage'] ?? 10;
	...
	$classes = 've-block ve-block-query-loop ve-block-editing ve-block-dynamic-preview';
@endphp
...
>
	<div style="opacity: 0.7; font-style: italic; padding: 0.5rem; border: 1px dashed currentColor; border-radius: 0.25rem;">
		{{ __( 'visual-editor::ve.query_loop_placeholder', [ 'type' => $queryType, 'perPage' => $perPage ] ) }}
	</div>

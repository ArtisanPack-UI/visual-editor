    ...
    public function registerDefaults(): void
    {
        ...
        $this->register('columns', [
            ...
            'settings_schema' => [
                ...
                'responsive_columns' => [
                    'type' => 'toggle',
                    'label' => __('Different columns at different screen sizes'),
                    'default' => false,
                ],
                'columns_sm' => [
                    'type' => 'range',
        ...
        $this->register('grid_item', [
            ...
            'settings_schema' => [
                ...
                'responsive_col_span' => [
                    'type' => 'toggle',
                    'label' => __('Different column spans at different screen sizes'),
                    'default' => false,
                ],
                'col_span_sm' => [
                    'type' => 'range',
                ...
                'responsive_row_span' => [
                    'type' => 'toggle',
                    'label' => __('Different row spans at different screen sizes'),
                    'default' => false,
                ],
                'row_span_sm' => [
                    'type' => 'range',

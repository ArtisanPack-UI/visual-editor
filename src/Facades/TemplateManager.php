 ...
 * @method static array allBaseTemplates()
 * @method static array variationsOf( int $parentId )
 * @method static \ArtisanPackUI\VisualEditor\Models\Template createVariation( \ArtisanPackUI\VisualEditor\Models\Template $template, string $slug, string $name, array $overrides = [] )

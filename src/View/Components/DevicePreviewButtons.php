...
/**
 * Device Preview Buttons component for switching device preview mode.
 *
 * @package    ArtisanPack_UI
 * @subpackage VisualEditor\View\Components
 *
 * @since      1.0.0
 */
class DevicePreviewButtons extends Component
{
	/**
	...
	{
		return view( 'visual-editor::components.device-preview-buttons' );
	}
}

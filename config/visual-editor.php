...
return [
	...
	|--------------------------------------------------------------------------
	|
	| Configuration for the visual editor API endpoints.
	|
	*/
	'api' => [
		'auth_guard' => env( 'VE_API_AUTH_GUARD', 'sanctum' ),
	],
	...
	'ai' => [
		...
		'providers'        => [
			...
			'anthropic' => [
				...
				'model'   => env( 'VE_ANTHROPIC_MODEL', 'claude-sonnet-4-20250514' ), // Override via VE_ANTHROPIC_MODEL
			],
		],
	],

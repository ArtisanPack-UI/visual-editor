...
var Es = gt(function({
  ...
  return v = xt(
    v,
    (R) => /* @__PURE__ */ C(Fr, { value: b, children: /* @__PURE__ */ C(fu.Provider, { value: le, children: /* @__PURE__ */ C(du.Provider, { value: Qe, children: R }) }) }),
    [b]
  ), v = {
    "data-dialog": "",
    role: "dialog",
...
async function cl(t, e) {
  ...
  const {
    ...
    x: 1,
    y: 1
  }, b = xn(o.convertOffsetParentRelativeRectToViewportRelativeRect ? await o.convertOffsetParentRelativeRectToViewportRelativeRect({
    elements: a,
    rect: v,
    offsetParent: y,
    strategy: u
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      if ((n = o.arrow) != null && n.alignmentOffset)
        return {};
      const x = Wt(i), v = Nt(a), y = Wt(a) === a, g = await (u.isRTL == null ? void 0 : u.isRTL(c.floating)), b = m || (y || !d ? [wn(a)] : nl(a)), E = p !== "none";
...
function Ll(t, e) {
  ...
  function s(a, u) {
    ...
    if (a || e(), !m || !h)
      return;
    const p = cn(f), d = cn(i.clientWidth - (l + m)), w = cn(i.clientHeight - (f + h)), x = cn(l), y = {
      ...
      case 0:
        switch (v) {
          ...
          case 59:
            S += ";";
          default:
            if (un(E = so(S, e, n, c, l, i, a, y, g = [], b = [], f), o), v === 123)
              if (l === 0)
                mn(S, e, E, E, g, o, f, a, b);
              else
                switch (m === 99 && nt(S, 3) === 110 ? 100 : m) {
                  ...
                  case 109:
                  case 115:
                    mn(t, E, E, r && un(so(t, E, E, 0, 0, i, a, y, i, g = [], f), b), i, b, f, a, r ? g : b);
                    break;
                  default:
                    mn(S, E, E, E, [""], b, 0, a, b);
                }
      ...
      default:
        ...
        switch (S += In(v), v * d) {
          ...
          case 44:
            ...
            break;
          case 64:
            Lt() === 45 && (S += pn(mt())), m = Lt(), l = f = Tt(y = S += Gf(dn())), v++;
            break;
          case 45:
            p === 45 && Tt(S) == 2 && (d = 0);
        }
...
function em(t, e) {
  ...
  const r = tr(n);
  return n[Me] = r, {
    ready: import("./editor-app-CLcuMv5M.js").then(
      ({ EditorApp: o }) => {
...
//# sourceMappingURL=main-BxhAgJ-n.js.map

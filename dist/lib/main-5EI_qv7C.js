...
if (process.env.NODE_ENV === "production")
  tr = tn.createRoot, tn.hydrateRoot;
else {
  var oi = tn.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
  tr = function(t, e) {
    oi.usingClientEntryPoint = !0;
    try {
      return tn.createRoot(t, e);
    } finally {
...
var li = wa, xa = class {
  ...
  didFilter;
  constructor() {
    this.actions = /* @__PURE__ */ Object.create(null), this.actions.__current = /* @__PURE__ */ new Set(), this.filters = /* @__PURE__ */ Object.create(null), this.filters.__current = /* @__PURE__ */ new Set(), this.addAction = si(this, "actions"), this.addFilter = si(this, "filters"), this.removeAction = en(this, "actions"), this.removeFilter = en(this, "filters"), this.hasAction = ai(this, "actions"), this.hasFilter = ai(this, "filters"), this.removeAllActions = en(this, "actions", !0), this.removeAllFilters = en(this, "filters", !0), this.doAction = nn(this, "actions", !1, !1), this.doActionAsync = nn(this, "actions", !1, !0), this.applyFilters = nn(this, "filters", !0, !1), this.applyFiltersAsync = nn(this, "filters", !0, !0), this.currentAction = ci(this, "actions"), this.currentFilter = ci(this, "filters"), this.doingAction = ui(this, "actions"), this.doingFilter = ui(this, "filters"), this.didAction = li(this, "actions"), this.didFilter = li(this, "filters");
  }
};
function Sa() {
  return new xa();
...
var bi = {
  ...
  const r = new br({}), i = /* @__PURE__ */ new Set(), o = () => {
    i.forEach((g) => g());
  }, s = (g) => (i.add(g), () => i.delete(g)), a = (g = "default") => r.data[g], u = (g, b = "default") => {
    r.data[b] = {
      ...r.data[b],
      ...g
    }, r.data[b][""] = {
    ...
    }, delete r.pluralForms[b], o();
  }, f = (g, b) => {
    r.data = {}, r.pluralForms = {}, c(g, b);
  }, m = (g = "default", b, E, S, A) => (r.data[g] || u(void 0, g), r.dcnpgettext(g, b, E, S, A)), h = (g) => g || "default", p = (g, b) => {
    let E = m(b, void 0, g);
  ...
  }, v = () => d("ltr", "text direction") === "rtl", y = (g, b, E) => {
    const S = b ? b + "" + g : g;
...
function ic(t, e) {
  return e === void 0 && (e = {}), rc(t, mn({ delimiter: "." }, e));
}
function oc(t, e) {
  return e === void 0 && (e = {}), ic(t, mn({ delimiter: "-" }, e));
}
var Mm = (t) => Se("circle", t), Fm = (t) => Se("g", t), Ho = (t) => Se("path", t), Lm = (t) => Se("rect", t), ke = Ot(
  ...
  ({ className: t, isPressed: e, ...n }, r) => {
    const i = {
      ...n,
      className: An(t, { "is-pressed": e }) || void 0,
      "aria-hidden": !0,
      focusable: !1
    };
...
function zo(t) {
  ...
  return o.current = t, Mt(() => {
    r.current === !1 && n.current === !0 && t.forEach((s, a) => {
      const u = i.current[a];
      s !== u && (rn(u, null), rn(s, e.current));
    }), i.current = t;
  }, t), Mt(() => {
    r.current = !1;
  }), At((s) => {
    rn(e, s), r.current = !0, n.current = s !== null;
...
function Jo() {
  return V(() => {
    Ti || (it("mousemove", Vc, !0), it("mousedown", on, !0), it("mouseup", on, !0), it("keydown", on, !0), it("scroll", on, !0), Ti = !0);
  }, []), Q(() => Pr);
}
var Pr = !1, Ri = 0, Di = 0;
function kc(t) {
...
var Tr = gt(
  function({
    ...
    const h = Bn(
      ...
      c
    ), d = Bn(o.onClickCapture, c), w = (P, M) => {
      if (M && (P.currentTarget = M), !e) return;
      ...
      Ci(M, "focusout", () => w(P, M));
    }), y = o.onFocusCapture, g = Q((P) => {
      if (y?.(P), P.defaultPrevented || !e) return;
      if (!Pi(P)) {
        m(!1);
        return;
      }
      const M = P.currentTarget, L = () => w(P, M);
      _r || qc(P.target) ? Ci(P.target, "focusout", L) : m(!1);
    }), b = o.onBlur, E = Q((P) => {
      b?.(P), e && de(P) && (P.currentTarget.removeAttribute("data-focus-visible"), m(!1));
    }), S = vt(Qo), A = Q((P) => {
      e && r && P && S && queueMicrotask(() => {
        Ni(P) || It(P) && P.focus();
      });
    }), _ = Mc(s), T = e && Jc(_), O = e && Qc(_), [N, D] = Y(!1);
    Kc && V(() => {
      if (!e) return;
      const P = s.current;
      if (!P) return;
      const M = P.tagName.toLowerCase(), L = P.type;
      D(eu(M, L));
    }, [e]);
...
function Yt(t, ...e) {
  let n = t, r = n, i = /* @__PURE__ */ Symbol(), o = ln;
  const s = /* @__PURE__ */ new Set(), a = /* @__PURE__ */ new Set(), u = /* @__PURE__ */ new Set(), c = /* @__PURE__ */ new Set(), l = /* @__PURE__ */ new Set(), f = /* @__PURE__ */ new WeakMap(), m = /* @__PURE__ */ new WeakMap(), h = (A) => (u.add(A), () => u.delete(A)), p = () => {
    ...
    const O = xc(n).map(
      (I) => ht(
        ...e.map((k) => {
          var P;
          const M = (P = k?.getState) == null ? void 0 : P.call(k);
          if (M && Bt(M, I))
            return Ht(k, [I], (L) => {
              E(
                I,
  ...
  }), w = (A, _) => d(A, _), x = (A, _) => (f.set(_, _(n, n)), d(A, _)), v = (A, _) => (f.set(_, _(n, r)), d(A, _, l)), y = (A) => Yt(bc(n, A), S), g = (A) => Yt(yc(n, A), S), b = () => n, E = (A, _, T = !1) => {
    var O;
    if (!Bt(n, A)) return;
    const N = hc(_, n[A]);
    if (N === n[A]) return;
    if (!T)
      for (const P of e)
        (O = P?.setState) == null || O.call(P, A, N);
    const D = n;
    n = { ...n, [A]: N };
    ...
    const k = (P, M, L) => {
      ...
      (!at || at.some(yt)) && ((z = f.get(P)) == null || z(), f.set(P, P(n, M)));
    };
    for (const P of c)
      k(P, D);
    queueMicrotask(() => {
...
var Lr = gt(function({ store: e, alwaysVisible: n, ...r }) {
  ...
  U(() => {
    ...
    let v;
    return e?.setState("animated", (y) => (v = y, !0)), () => {
    ...
    if (!e || !f || !a || !m) return;
    const v = () => e?.setState("animating", !1), y = () => Ro(v);
...
var Cn = Ge(
  [lu],
  [Fr]
), sh = Cn.useContext, ls = Cn.useProviderContext, gu = Cn.ContextProvider, fs = Cn.ScopedContextProvider, Ue = Ge(
  [gu],
  [fs]
);
Ue.useContext;
Ue.useScopedContext;
var kr = Ue.useProviderContext, yu = Ue.ContextProvider, ds = Ue.ScopedContextProvider, ps = Ge(
  [yu],
  [ds]
...
var hs = gt(function({
  ...
  return U(() => {
    ...
    const g = y.isConnected;
    if (g || (c || Wi(v)).appendChild(y), y.id || (y.id = v.id ? `portal/${v.id}` : Cu()), f(y), or(i, y), !g)
      return () => {
        y.remove(), or(i, null);
      };
  }, [o, r, c, i]), V(() => {
    ...
    return y(), v.addEventListener("fullscreenchange", y), () => {
      v.removeEventListener("fullscreenchange", y);
    };
  }, [l, c, r]), U(() => {
    if (!o || !e || !n) return;
    const y = K(n).createElement("span");
    return y.style.position = "fixed", n.insertAdjacentElement("afterend", y), h(y), () => {
      y.remove(), h(null);
    };
  }, [o, e, n]), V(() => {
    if (!l || !e) return;
    ...
    const y = (g) => {
      if (!de(g)) return;
      const b = g.type === "focusin";
      if (cancelAnimationFrame(v), b)
        return Uc(l);
    ...
    return l.addEventListener("focusin", y, !0), l.addEventListener("focusout", y, !0), () => {
      cancelAnimationFrame(v), l.removeEventListener("focusin", y, !0), l.removeEventListener("focusout", y, !0);
    };
  }, [l, e]), s = xt(
    s,
    (v) => {
...
function zu(t, e, n) {
  ...
  V(() => {
    ...
    const i = K(t), o = Ve(t), { documentElement: s, body: a } = i, u = s.style.getPropertyValue("--scrollbar-width"), c = u ? Number.parseInt(u, 10) : o.innerWidth - s.clientWidth, l = () => Du(
      ...
      var d, w;
      const { scrollX: x, scrollY: v, visualViewport: y } = o, g = (d = y?.offsetLeft) != null ? d : 0, b = (w = y?.offsetTop) != null ? w : 0, E = ar(a, {
        position: "fixed",
        overflow: "hidden",
        top: `${-(v - Math.floor(b))}px`,
...
function ws(t, e) {
  if (!("style" in t)) return ln;
  if (bs())
    return se(t, "inert", !0);
  const r = Pn(t, !0).map((i) => {
    if (e?.some((s) => s && Z(s, i))) return ln;
    const o = Xe(i, "focus", () => (i.focus = ln, () => {
      delete i.focus;
    }));
...
function Zu({
  ...
  return e ? Fe(e) ? /* @__PURE__ */ C(gn, { ...a, render: e }) : /* @__PURE__ */ C(gn, { ...a, render: /* @__PURE__ */ C(typeof e != "boolean" ? e : "div", {}) }) : null;
}
function xs(t = {}) {
  return cs(t);
}
...
var Es = gt(function({
  ...
  const y = Mr(), g = F(null), b = qu({
    ...
    setOpen(R) {
      ...
      r && G.addEventListener("close", r, { once: !0 }), G.dispatchEvent(X), X.defaultPrevented && b.setOpen(!0);
    }
  }), { portalRef: E, domReady: S } = Ar(s, v.portalRef), A = v.preserveTabOrder, _ = $(
    b,
    (R) => A && !o && R.mounted
  ), T = Zo(v.id), O = $(b, "open"), N = $(b, "mounted"), D = $(b, "contentElement"), I = as(N, v.hidden, v.alwaysVisible);
  zu(D, T, f && !I);
  const k = F(!1);
  U(() => Ht(b, ["open"], (R) => {
    R.open && (k.current = !1);
  ...
  const { wrapElement: P, nestedDialogs: M } = Hu(b);
  v = xt(v, P, [P]);
  const L = F(null);
  Ui && V(() => {
    if (!S) return;
    ...
    if (G) {
      if (G.tagName === "BODY") {
        ...
        b.setDisclosureElement(X);
        return;
      }
      R && Z(R, G) || b.setDisclosureElement(G);
    }
  }, [b, O]), V(() => {
    if (!N || !S) return;
    const R = g.current;
  ...
  U(() => {
    if (!T || !z) return;
    const { disclosureElement: R } = b.getState(), G = g.current, X = at() || [], j = [
      G,
      ...X,
      ...M.map((ft) => ft.getState().contentElement)
    ];
    return o ? ht(
      zi(T, j),
      Xu(T, j)
  ...
  V(() => {
    ...
    tt(G ? R : null) && (Oe(!0), queueMicrotask(() => {
      b.getState().open && (R.focus(), Ui && G && R.scrollIntoView({ block: "nearest", inline: "nearest" }));
    }));
  }, [
    O,
    yt,
  ...
  const ee = At(
    (R, G = !0) => {
      if (k.current) return;
      const { disclosureElement: X } = b.getState();
      if (Qu(R)) return;
      let j = Xi(d) || X;
      if (j?.id) {
        const bt = K(j), fe = `[aria-activedescendant="${j.id}"]`, Qe = bt.querySelector(fe);
        Qe && (j = Qe);
      }
      if (j && !It(j)) {
        const bt = j.closest("[data-dialog]");
        if (bt?.id) {
          const fe = K(bt), Qe = `[aria-controls~="${bt.id}"]`, ii = fe.querySelector(Qe);
          ii && (j = ii);
        }
      }
      const ft = j && It(j);
  ...
  V(() => {
    ...
    const R = (X) => {
      ...
      const ft = X.target;
      if (!ft) return;
      const { disclosureElement: bt } = b.getState();
      !!(ft.tagName === "BODY" || Z(j, ft) || !bt || Z(bt, ft)) && ne(X) && b.hide();
    }, G = D ? Ve(D) : void 0;
  ...
  const [ue, le] = Y(), [qe, Je] = Y();
  return v = xt(
    v,
    (R) => /* @__PURE__ */ C(Fr, { value: b, children: /* @__PURE__ */ C(fu.Provider, { value: le, children: /* @__PURE__ */ C(du.Provider, { value: Je, children: R }) }) }),
    [b]
  ), v = {
    "data-dialog": "",
    role: "dialog",
    ...
    ...v,
    autoFocusOnShow: _t
  }), v = Lr({ store: b, ...v }), v = Tr({ ...v, focusable: i }), v = hs({ portal: s, ...v, portalRef: E, preserveTabOrder: _ }), v;
});
function On(t, e = Mr) {
...
const Kt = Math.min, dt = Math.max, yn = Math.round, an = Math.floor, Ft = (t) => ({
  x: t,
  y: t
}), tl = {
  left: "right",
...
function el(t, e, n) {
  ...
  return e.reference[o] > e.floating[o] && (s = bn(s)), [s, bn(s)];
}
function nl(t) {
  const e = bn(t);
  return [lr(t), e, lr(e)];
...
async function cl(t, e) {
  ...
  const {
    ...
    altBoundary: m = !1,
    padding: h = 0
  } = Zt(e, t), p = As(h), w = a[m ? f === "floating" ? "reference" : "floating" : f], x = wn(await o.getClippingRect({
  ...
  } : s.reference, y = await (o.getOffsetParent == null ? void 0 : o.getOffsetParent(a.floating)), g = await (o.isElement == null ? void 0 : o.isElement(y)) ? await (o.getScale == null ? void 0 : o.getScale(y)) || {
    x: 1,
    y: 1
  } : {
    x: 1,
    y: 1
  }, b = wn(o.convertOffsetParentRelativeRectToViewportRelativeRect ? await o.convertOffsetParentRelativeRectToViewportRelativeRect({
    elements: a,
    rect: v,
    offsetParent: y,
    strategy: u
  ...
  return {
    top: (x.top - b.top + p.top) / g.y,
    bottom: (b.bottom - x.bottom + p.bottom) / g.y,
    left: (x.left - b.left + p.left) / g.x,
    right: (b.right - x.right + p.right) / g.x
  };
}
const ul = 50, ll = async (t, e, n) => {
  ...
  async fn(e) {
    ...
    const f = As(l), m = {
      x: n,
      y: r
    }, h = zr(i), p = jr(h), d = await s.getDimensions(c), w = h === "y", x = w ? "top" : "left", v = w ? "bottom" : "right", y = w ? "clientHeight" : "clientWidth", g = o.reference[p] + o.reference[h] - m[h] - o.floating[p], b = m[h] - o.reference[h], E = await (s.getOffsetParent == null ? void 0 : s.getOffsetParent(c));
    let S = E ? E[y] : 0;
    (!S || !await (s.isElement == null ? void 0 : s.isElement(E))) && (S = a.floating[y] || o.floating[p]);
    const A = g / 2 - b / 2, _ = S / 2 - d[p] / 2 - 1, T = Kt(f[x], _), O = Kt(f[v], _), N = T, D = S - d[p] - O, I = S / 2 - d[p] / 2 + A, k = ur(N, I, D), P = !u.arrow && Ae(i) != null && I !== k && o.reference[p] / 2 - (I < N ? T : O) - d[p] / 2 < 0, M = P ? I < N ? I - N : I - D : 0;
    return {
      [h]: m[h] + M,
      data: {
        [h]: k,
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      if ((n = o.arrow) != null && n.alignmentOffset)
        return {};
      const x = Wt(i), v = Nt(a), y = Wt(a) === a, g = await (u.isRTL == null ? void 0 : u.isRTL(c.floating)), b = m || (y || !d ? [bn(a)] : nl(a)), E = p !== "none";
      !m && E && b.push(...sl(a, d, p, g));
      const S = [a, ...b], A = await u.detectOverflow(e, w), _ = [];
      ...
      if (T = [...T, {
        ...
        let P = (N = T.filter((M) => M.overflows[0] <= 0).sort((M, L) => M.overflows[1] - L.overflows[1])[0]) == null ? void 0 : N.placement;
        if (!P)
          switch (h) {
            case "bestFit": {
              var D;
              const M = (D = T.filter((L) => {
                if (E) {
...
const ml = function(t) {
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      let p = l[h], d = l[m];
      if (s) {
        const x = h === "y" ? "top" : "left", v = h === "y" ? "bottom" : "right", y = p + f[x], g = p - f[v];
        p = ur(y, p, g);
      }
      if (a) {
        const x = m === "y" ? "top" : "left", v = m === "y" ? "bottom" : "right", y = d + f[x], g = d - f[v];
        d = ur(y, d, g);
      }
      const w = u.fn({
        ...e,
  ...
  return t === void 0 && (t = {}), {
    ...
    fn(e) {
      ...
      if (u) {
        const y = m === "y" ? "height" : "width", g = o.reference[m] - o.floating[y] + w.mainAxis, b = o.reference[m] + o.reference[y] - w.mainAxis;
        h < g ? h = g : h > b && (h = b);
      }
      if (c) {
        var x, v;
        const y = m === "y" ? "width" : "height", g = Ps.has(Wt(i)), b = o.reference[f] - o.floating[y] + (g && ((x = s.offset) == null ? void 0 : x[f]) || 0) + (g ? 0 : w.crossAxis), E = o.reference[f] + o.reference[y] + (g ? 0 : ((v = s.offset) == null ? void 0 : v[f]) || 0) - (g ? w.crossAxis : 0);
        p < b ? p = b : p > E && (p = E);
      }
      return {
        [m]: h,
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      const v = d - l.top - l.bottom, y = p - l.left - l.right, g = Kt(d - l[w], v), b = Kt(p - l[x], y), E = !e.middlewareData.shift;
      let S = g, A = b;
      if ((n = e.middlewareData.shift) != null && n.enabled.x && (A = y), (r = e.middlewareData.shift) != null && r.enabled.y && (S = v), E && !m) {
        const T = dt(l.left, 0), O = dt(l.right, 0), N = dt(l.top, 0), D = dt(l.bottom, 0);
        h ? A = p - 2 * (T !== 0 || O !== 0 ? T + O : dt(l.left, l.right)) : S = d - 2 * (N !== 0 || D !== 0 ? N + D : dt(l.top, l.bottom));
      }
      await u({
        ...e,
        availableWidth: A,
...
function Os(t) {
  const e = qt(t);
  return be(e) ? t.ownerDocument ? t.ownerDocument.body : t.body : zt(e) && Ye(e) ? e : Os(e);
}
function Be(t, e, n) {
  var r;
  ...
  if (o) {
    const a = fr(s);
    return e.concat(s, s.visualViewport || [], Ye(i) ? i : [], a && n ? Be(a) : []);
  } else
...
function _s(t) {
  ...
  const i = zt(t), o = i ? t.offsetWidth : n, s = i ? t.offsetHeight : r, a = yn(n) !== o || yn(r) !== s;
  return a && (n = o, r = s), {
    width: n,
    height: r,
    $: a
...
function ve(t) {
  ...
  let s = (o ? yn(n.width) : n.width) / r, a = (o ? yn(n.height) : n.height) / i;
...
function ae(t, e, n, r) {
  ...
  if (o) {
    ...
    let p = m, d = fr(p);
    for (; d && r && h !== p; ) {
      const w = ve(d), x = d.getBoundingClientRect(), v = Ct(d), y = x.left + (d.clientLeft + parseFloat(v.paddingLeft)) * w.x, g = x.top + (d.clientTop + parseFloat(v.paddingTop)) * w.y;
      u *= w.x, c *= w.y, l *= w.x, f *= w.y, u += y, c += g, p = pt(d), d = fr(p);
    }
  }
  return wn({
    width: l,
...
function Al(t) {
  ...
  const l = Ft(0), f = zt(r);
  if ((f || !f && !o) && ((Pe(r) !== "body" || Ye(s)) && (u = Rn(r)), f)) {
    const h = ae(r);
...
function Tl(t, e) {
  ...
  for (; Pt(s) && !be(s); ) {
    const a = Ct(s), u = Gr(s);
    !u && a.position === "fixed" && (i = null), (o ? !u && !i : !u && a.position === "static" && !!i && (i.position === "absolute" || i.position === "fixed") || Ye(s) && !u && Ds(t, s)) ? r = r.filter((l) => l !== s) : i = a, s = qt(s);
  }
  return e.set(t, r), r;
}
function Rl(t) {
...
function Ll(t, e) {
  ...
  function s(a, u) {
    ...
    if (a || e(), !m || !h)
      return;
    const p = an(f), d = an(i.clientWidth - (l + m)), w = an(i.clientHeight - (f + h)), x = an(l), y = {
...
var Ms = gt(
  function({
    ...
    const b = $(e, "arrowElement"), E = $(e, "anchorElement"), S = $(e, "disclosureElement"), A = $(e, "popoverElement"), _ = $(e, "contentElement"), T = $(e, "placement"), O = $(e, "mounted"), N = $(e, "rendered"), D = F(null), [I, k] = Y(!1), { portalRef: P, domReady: M } = Ar(r, y.portalRef), L = Q(x), z = Q(v), at = !!v;
    U(() => {
      ...
      const tt = Xl(E, L), _t = async () => {
        if (!O) return;
        b || (D.current = D.current || document.createElement("div"));
        const wt = b || D.current, Ut = [
        ...
        if (Object.assign(A.style, {
          ...
          const { x: ne, y: re } = lt.middlewareData.arrow, Te = lt.placement.split("-")[0], ue = wt.clientWidth / 2, le = wt.clientHeight / 2, qe = ne != null ? ne + ue : -ue, Je = re != null ? re + le : -le;
          A.style.setProperty(
            "--popover-transform-origin",
            {
              top: `${qe}px calc(100% + ${le}px)`,
              bottom: `${qe}px ${-le}px`,
              left: `calc(100% + ${ue}px) ${Je}px`,
              right: `${-ue}px ${Je}px`
            }[Te]
      ...
      if (!O || !M || !A?.isConnected || !_?.isConnected) return;
      const tt = () => {
...
var ro = kt(null), Ls = gt(
  function({
    ...
    const c = F(null), [l, f] = Y([]), m = F(0), h = F(null), { portalRef: p, domReady: d } = Ar(r, a.portalRef), w = Jo(), x = !!o, v = he(o), y = !!s, g = he(
      s
    ), b = $(e, "open"), E = $(e, "mounted");
    V(() => {
      if (!d || !E || !x && !y) return;
      const O = c.current;
      return O ? ht(
        it("mousemove", (D) => {
          if (!e || !w()) return;
          const { anchorElement: I, hideTimeout: k, timeout: P } = e.getState(), M = h.current, [L] = D.composedPath(), z = I;
          if (Fs(L, O, z, l)) {
    ...
    return a = Ms({
      ...
      portalRef: p,
      hideOnEscape(O) {
        return vn(i, O) ? !1 : (requestAnimationFrame(() => {
          requestAnimationFrame(() => {
            e?.hide();
          });
        }), !0);
...
var nf = "div", rf = gt(
  ...
  function({ store: e, showOnHover: n = !0, ...r }) {
    ...
    const a = r.onMouseMove, u = he(n), c = Jo(), l = Q((p) => {
      ...
      y === 0 ? v() : s.current = window.setTimeout(v, y);
    }), f = r.onClick, m = Q((p) => {
...
}(), ot = "-ms-", xn = "-moz-", B = "-webkit-", Bs = "comm", Zr = "rule", qr = "decl", Nf = "@import", Hs = "@keyframes", Mf = "@layer", Ff = Math.abs, In = String.fromCharCode, Lf = Object.assign;
function kf(t, e) {
...
function dn(t) {
  return Ws(Ke(ct - 1, pr(t === 91 ? t + 2 : t === 40 ? t + 1 : t)));
}
function Wf(t) {
  for (; (q = Lt()) && q < 33; )
    mt();
...
function jf(t, e) {
  for (; --e && mt() && !(q < 48 || q > 102 || q > 57 && q < 65 || q > 70 && q < 97); )
    ;
  return Ke(t, fn() + (e < 6 && Lt() == 32 && mt() == 32));
}
function pr(t) {
  for (; mt(); )
    switch (q) {
...
function Uf(t) {
  return Gs(pn("", null, null, null, [""], t = zs(t), 0, [0], t));
}
function pn(t, e, n, r, i, o, s, a, u) {
  for (var c = 0, l = 0, f = s, m = 0, h = 0, p = 0, d = 1, w = 1, x = 1, v = 0, y = "", g = i, b = o, E = r, S = y; w; )
    switch (p = v, v = mt()) {
      case 40:
        if (p != 108 && nt(S, f - 1) == 58) {
          dr(S += H(dn(v), "&", "&\f"), "&\f") != -1 && (x = -1);
          break;
        }
      case 34:
      case 39:
      ...
      case 0:
        switch (v) {
          ...
          case 125:
            w = 0;
          case 59 + l:
            x == -1 && (S = H(S, /\f/g, "")), h > 0 && Tt(S) - f && cn(h > 32 ? ao(S + ";", r, n, f - 1) : ao(H(S, " ", "") + ";", r, n, f - 2), u);
            break;
          case 59:
            S += ";";
          default:
            if (cn(E = so(S, e, n, c, l, i, a, y, g = [], b = [], f), o), v === 123)
              if (l === 0)
                pn(S, e, E, E, g, o, f, a, b);
              else
                switch (m === 99 && nt(S, 3) === 110 ? 100 : m) {
                  ...
                  case 109:
                  case 115:
                    pn(t, E, E, r && cn(so(t, E, E, 0, 0, i, a, y, i, g = [], f), b), i, b, f, a, r ? g : b);
                    break;
                  default:
                    pn(S, E, E, E, [""], b, 0, a, b);
                }
        }
        c = l = h = 0, d = x = 1, y = S = "", f = s;
        break;
      case 58:
        f = 1 + Tt(S), h = p;
      default:
        ...
        switch (S += In(v), v * d) {
          ...
          case 44:
            ...
            break;
          case 64:
            Lt() === 45 && (S += dn(mt())), m = Lt(), l = f = Tt(y = S += Gf(fn())), v++;
            break;
          case 45:
            p === 45 && Tt(S) == 2 && (d = 0);
        }
...
function so(t, e, n, r, i, o, s, a, u, c, l) {
  for (var f = i - 1, m = i === 0 ? o : [""], h = Jr(m), p = 0, d = 0, w = 0; p < r; ++p)
    for (var x = 0, v = He(t, f + 1, f = Ff(d = s[p])), y = t; x < h; ++x)
      (y = Ws(d > 0 ? m[x] + " " + v : H(v, /&\f/g, m[x]))) && (u[w++] = y);
  ...
  switch (kf(t, e)) {
    ...
    case 4765:
      if (Tt(t) - 1 - e > 6) switch (nt(t, e + 1)) {
        ...
        case 102:
          return H(t, /(.+:)(.+)-([^]+)/, "$1" + B + "$2-$3$1" + xn + (nt(t, e + 3) == 108 ? "$3" : "$2-$3")) + t;
        case 115:
...
var nd = function(e, n, r, i) {
    ...
    case Zr:
      if (e.length) return $f(e.props, function(o) {
        switch (Vf(o, /(::plac\w+|:read-\w+)/)) {
          ...
          case ":read-write":
            return ge([Re(e, {
              props: [H(o, /:(read-\w+)/, ":" + xn + "$1")]
            })], i);
          case "::placeholder":
            return ge([Re(e, {
              props: [H(o, /:(plac\w+)/, ":" + B + "input-$1")]
            }), Re(e, {
              props: [H(o, /:(plac\w+)/, ":" + xn + "$1")]
            }), Re(e, {
  ...
  var u, c = [td, ed];
  {
    ...
    u = function(w, x, v, y) {
      l = v, h(w ? w + "{" + x.styles + "}" : x.styles), y && (p.inserted[x.name] = !0);
    };
  }
  var p = {
    key: n,
...
function Td(t, e) {
  ...
  if (f)
    return p ? /* @__PURE__ */ C(gn, {
      ...l,
      render: n
    }) : n;
  function v(y) {
    return h && x && y.props["aria-describedby"] === void 0 && y.props["aria-label"] !== c ? Le(y, {
      "aria-describedby": h
    }) : y;
  }
  return /* @__PURE__ */ Et(vr.Provider, {
    ...
    children: [/* @__PURE__ */ C(uf, {
      ...
      ...l,
      className: An("components-tooltip", r),
      unmountOnHide: !0,
      gutter: 4,
      id: h,
      overflowPadding: 0.5,
...
var ip = {
  ...
  return function() {
    ...
    var d = Zs(function(w, x, v) {
      ...
      typeof w.className == "string" ? g = Fn(x.registered, b, w.className) : w.className != null && (g = w.className + " ");
      var A = Ne(f.concat(b), x.registered, E);
      g += x.key + "-" + A.name, s !== void 0 && (g += " " + s);
      var _ = c && a === void 0 ? bo(y) : u, T = {};
      for (var O in w)
        c && O === "as" || _(O) && (T[O] = w[O]);
...
var Sn = wp, xp = ["onMouseDown", "onClick"];
function Sp({
...
function Ep(t, e) {
  const {
    ...
    target: void 0,
    ...g
  }, O = jo(ri, "components-button__description"), N = typeof d == "string" && !!d || Array.isArray(d) && d?.[0] && d[0] !== null && // Tooltip should not considered as a child
  d?.[0]?.props?.className !== "components-tooltip", I = An("components-button", s, {
  ...
  }), k = a && !r, P = b !== void 0 && !a ? "a" : "button", M = P === "button" ? {
    type: "button",
    disabled: k,
    "aria-checked": S,
    "aria-pressed": A,
  ...
  if (a && r) {
    M["aria-disabled"] = !0, L["aria-disabled"] = !0;
    for (const Ut of xp)
      z[Ut] = (lt) => {
  ...
  f !== !1), yt = y ? O : void 0, tt = T["aria-describedby"] || yt, _t = {
    className: I,
    "aria-label": T["aria-label"] || p,
    "aria-describedby": tt,
    ref: e
  }, Oe = /* @__PURE__ */ Et(St, {
    children: [u && c === "left" && /* @__PURE__ */ C(Sn, {
      icon: u,
      size: l
    }), x && /* @__PURE__ */ C(St, {
      children: x
    }), d, u && c === "right" && /* @__PURE__ */ C(Sn, {
      icon: u,
      size: l
    })]
  }), Gt = P === "a" ? /* @__PURE__ */ C("a", {
...
function Wp({
  ...
  return !vt(Ze).isDefault && e ? /* @__PURE__ */ C(St, {
    children: t
  }) : /* @__PURE__ */ C(Hp, {
    children: t
  });
...
function Gp(t, e) {
  ...
  const x = An("components-panel__body", i, {
    "is-opened": f
  });
...
function Qp(t) {
  ...
  let y;
  f === void 0 ? y = void 0 : f === "" ? y = null : y = Oo(f) ?? void 0;
  const g = Oo(m), b = Ie(
    ...
    t.dataset.supports,
    "data-supports"
  ), _ = Ie(t.dataset.breakpoints, "data-breakpoints"), T = Array.isArray(_) ? { breakpoints: _ } : null, O = tm(u, S);
  return {
    apiBase: e,
    resource: n,
    id: r,
    ...
    ...O !== void 0 ? { initialAuthorId: O } : {},
    ...c !== void 0 ? { initialCommentsOpen: c === "true" } : {},
    ...b !== null ? { initialFeaturedImage: b } : {},
    ...S !== null ? { authorOptions: S } : {},
    ...A !== null ? { supports: A } : {},
    ...x !== null ? { initialCategories: x } : {},
    ...v !== null ? { initialTags: v } : {},
    ...y !== void 0 ? { initialParent: y } : {},
    ...g !== null ? { initialMenuOrder: g } : {},
    ...h ? { initialTemplate: h } : {},
    ...p ? { initialCreatedAt: p } : {},
    ...d ? { initialUpdatedAt: d } : {},
    ...T !== null ? { breakpoints: T } : {},
    ...w ? { siteEditorRouteBase: w } : {},
    previewUrl: l ?? null
  };
}
function Co(t, e) {
...
function em(t, e) {
  ...
  const r = tr(n);
  return n[Me] = r, {
    ready: import("./editor-app-DEbXeiIR.js").then(
      ({ EditorApp: o }) => {
...
function En(t = document) {
  const e = t.querySelectorAll(Jp);
  return Promise.all(Array.from(e).map((n) => nm(n)));
}
typeof window < "u" && (window.ApVisualEditorBoot = En, window.ApVisualEditor = {
  boot: En,
...
//# sourceMappingURL=main-5EI_qv7C.js.map
